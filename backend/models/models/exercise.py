...
class Exercise(BaseModel):
    ...
    rest: Optional[StrictInt] = 90
    __properties: ClassVar[List[str]] = ["name", "weight_kg", "repetitions", "duration_sec", "rest"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "rest": obj.get("rest") if obj.get("rest") is not None else 90
        })
        return _obj
