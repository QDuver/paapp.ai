...
class ExerciseDay(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "day": obj.get("day"),
            "at_home": obj.get("at_home") if obj.get("at_home") is not None else False,
            "wakeup_time": obj.get("wakeup_time"),
            "available_exercise_time": obj.get("available_exercise_time"),
